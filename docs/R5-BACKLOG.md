...
- [ ] Bind production navigation contexts to exact origin authority and route Storage access through Host authorization.
- [ ] Define storage IPC/request contracts without exposing filesystem paths or backend handles to Site code.
...
- [ ] Add bounded worker identities, ownership and lifecycle.
