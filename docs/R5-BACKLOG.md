...
- [x] Add Service Worker registration/scope/lifecycle foundation.
- [x] Keep Service Worker fetch interception behind Rarog Fetch/Host security policy.
...
- [x] Add a WebGL context/resource abstraction with explicit GPU limits and loss semantics.
- [x] Keep graphics backend objects outside DOM/Web API contracts.
