...
- [ ] Wire the bounded non-spanning fractional subset into CSS-visible Grid syntax.
- [ ] Continue richer Grid max-track sizing without coupling CSS parser AST types to layout.
