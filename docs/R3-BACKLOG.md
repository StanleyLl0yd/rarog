...
- [ ] Wire definite Grid content-box space and content-distribution semantics into the intrinsic state pipeline, then remove the max-content compatibility projection.
